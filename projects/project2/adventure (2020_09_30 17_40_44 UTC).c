//Purpose: Build your own adventure game w/switch function
//Name: adventure.c
...
int health = 10, chest, bag, ogre, sword, shield;
double wealth = 0.0;
...
if(1 % ogre == 0){                                                              //fight
      switch(sword + shield){
            case 7:                                                               //have both shield and sword
                health = health + 12;
